...
test_data = torchvision.datasets.MNIST(DATASET_DIR,train=False,transform=torchvision.transforms.ToTensor())
test_dataloader = Data.DataLoader(test_data, batch_size=TEST_DATA_BANTCH, shuffle=True)
